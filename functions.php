...
function bayrak_get_translations() {
	...
	$dict = array(
		'en' => array(
			...
			'step_1_sub' => 'Choose the primary service category your vessel requires to start your quotation.',
			...
			'solas_hero_title' => 'Certified Maritime Safety & SOLAS Compliance',
			'solas_hero_sub' => 'Equipping global fleets with reliable, class-approved life-saving and fire-fighting systems across all Egyptian ports.',
			'solas_hero_cta' => 'Request Safety Inspection',
			'solas_sec_title' => 'Safety Equipment Categories',
			'solas_c1_title' => 'Life-Saving Appliances (LSA)',
			'solas_c1_desc' => 'Life jackets, lifebuoys, lifeboats, and survival suits certified under international standards.',
			'solas_c2_title' => 'Fire-Fighting Equipment (FFE)',
			'solas_c2_desc' => 'Extinguishers, fire hoses, pumps, and protective gear maintained for immediate operational readiness.',
			'solas_c3_title' => 'Pyrotechnics & Signaling',
			'solas_c3_desc' => 'Parachute flares, smoke signals, and line-throwing appliances compliant with SOLAS/IMO regulations.',
			'view_catalog' => 'View Catalog',
			'uncompromising_safety_title' => 'Uncompromising Safety Standards',
			'uncompromising_safety_sub' => 'We ensure your vessel remains fully compliant with latest maritime regulations through precise sourcing and certified equipment maintenance.',
			'solas_approved' => 'SOLAS Approved',
			'iso_cert_logistics' => 'ISO Certified Logistics',
			'annual_inspections' => 'Annual Inspections & Servicing',
			'rapid_port_delivery' => 'Rapid Port Delivery',
			'secure_vessel_safety_title' => 'Secure Your Vessel\'s Safety',
			'secure_vessel_safety_sub' => 'Contact our safety specialists today for a comprehensive quote on SOLAS-compliant equipment and maintenance services.',
		),
		'ar' => array(
			'home' => 'الرئيسية',
			...
			'step_1_sub' => 'اختر فئة الخدمة الرئيسية التي تحتاجها سفينتك لبدء طلب التسعير.',
			...
			'solas_hero_title' => 'السلامة البحرية المعتمدة والامتثال لاتفاقية سولاس (SOLAS)',
			'solas_hero_sub' => 'تجهيز الأساطيل العالمية بأنظمة إنقاذ الحياة ومكافحة الحريق المعتمدة والموثوقة في جميع الموانئ المصرية.',
			'solas_hero_cta' => 'طلب فحص واختبار أجهزة السلامة',
			'solas_sec_title' => 'فئات معدات ومهمات السلامة',
			'solas_c1_title' => 'أجهزة إنقاذ الحياة (LSA)',
			'solas_c1_desc' => 'أطوق وسترات النجاة، قوارب النجاة، وبدلات الغطس الحرارية المعتمدة وفق المعايير الدولية.',
			'solas_c2_title' => 'معدات وأجهزة مكافحة الحريق (FFE)',
			'solas_c2_desc' => 'أجهزة الإطفاء، الخراطيم، المضخات، ومعدات الحماية الشخصية المجهزة للجاهزية الفورية.',
			'solas_c3_title' => 'الألعاب النارية الملاحية ومعدات الإشارة',
			'solas_c3_desc' => 'الصواريخ البراشوتية، الإشارات الدخانية، وأجهزة إطلاق الحبال المطابقة للوائح SOLAS/IMO.',
			'view_catalog' => 'عرض الكتالوج',
			'uncompromising_safety_title' => 'معايير سلامة صارمة ولا تقبل المساومة',
			'uncompromising_safety_sub' => 'نضمن بقاء سفينتك مطابقة تماماً لأحدث اللوائح البحرية من خلال التوريد الدقيق وصيانة المعدات المعتمدة.',
			'solas_approved' => 'معتمد من اتفاقية سولاس (SOLAS)',
			'iso_cert_logistics' => 'خدمات لوجستية معتمدة بشهادات ISO',
			'annual_inspections' => 'الفحص السنوي والصيانة الدورية',
			'rapid_port_delivery' => 'توصيل سريع للموانئ',
			'secure_vessel_safety_title' => 'احمِ سلامة سفينتك وأبحر بثقة',
			'secure_vessel_safety_sub' => 'تواصل مع متخصصي السلامة لدينا اليوم للحصول على عرض أسعار شامل للمعدات والخدمات المعتمدة.',
		),
		'tr' => array(
			'home' => 'Ana Sayfa',
			'services' => 'Hizmetler',
			...
			'step_1_sub' => 'Teklif talebinize başlamak için geminizin ihtiyaç duyduğu ana hizmet kategorisini seçin.',
			...
			'solas_hero_title' => 'Sertifikalı Deniz Güvenliği ve SOLAS Uyumluğu',
			'solas_hero_sub' => 'Tüm Mısır limanlarında küresel filoları sertifikalı can kurtarma ve yangın söndürme sistemleriyle donatıyoruz.',
			'solas_hero_cta' => 'Güvenlik Muayenesi Talep Et',
			'solas_sec_title' => 'Deniz Emniyet Ekipmanları Kategorileri',
			'solas_c1_title' => 'Can Kurtarma Donanımları (LSA)',
			'solas_c1_desc' => 'Uluslararası standartlarda sertifikalı can yelekleri, can simitleri, filikalar ve dalış tulumları.',
			'solas_c2_title' => 'Yangın Söndürme Ekipmanları (FFE)',
			'solas_c2_desc' => 'Anında kullanım için hazır tutulan yangın söndürücüler, hortumlar, pompalar ve koruyucu donanımlar.',
			'solas_c3_title' => 'Deniz Piroteknik ve İşaret Malzemeleri',
			'solas_c3_desc' => 'SOLAS/IMO kurallarına uygun paraşütlü fişekler, duman kandilleri ve halat atma tüfekleri.',
			'view_catalog' => 'Kataloğu İncele',
			'uncompromising_safety_title' => 'Tavizsiz Güvenlik Standartları',
			'uncompromising_safety_sub' => 'Doğru tedarik ve sertifikalı ekipman bakımıyla geminizin en son denizcilik kurallarına tam uyumunu sağlıyoruz.',
			'solas_approved' => 'SOLAS Onaylı',
			'iso_cert_logistics' => 'ISO Sertifikalı Lojistik',
			'annual_inspections' => 'Yıllık Muayene ve Bakım Hizmetleri',
			'rapid_port_delivery' => 'Hızlı Liman Teslimatı',
			'secure_vessel_safety_title' => 'Geminizin Güvenliğini Sağlama Alın',
			'secure_vessel_safety_sub' => 'SOLAS uyumlu ekipmanlar ve bakım hizmetleri için uzmanlarımızdan teklif alın.',
		),
	);
