...
<span class="inline-block bg-secondary-container text-on-secondary px-3 py-1 rounded font-label-caps text-xs uppercase tracking-wider mb-4">About Hanil Marine</span>
<h1 class="font-headline-xl text-headline-xl md:text-[52px] text-on-primary mb-6 max-w-3xl drop-shadow-lg">Licensed Ship Chandlers & Marine Logistics in Egypt</h1>
<p class="font-body-lg text-body-lg max-w-2xl text-primary-fixed">Direct marine supply, bonded stores, deck & engine spares, and port clearance across Port Said, Suez Canal, Alexandria, Damietta, and Ain Sokhna.</p>
</div>
</section>
...
<h2 class="font-headline-lg text-headline-lg-mobile md:text-headline-lg text-primary mb-6">Built for Marine Dispatch & Fleet Operations</h2>
<p class="font-body-md text-body-md text-on-surface-variant mb-4">Hanil Marine (Al-Bayrak) serves shipowners, managers, charterers, and technical superintendents navigating Egyptian ports and the Suez Canal. We know that vessel turnaround time is critical, and any delay costs money.</p>
<p class="font-body-md text-body-md text-on-surface-variant">Our team operates dedicated supply launch boats for anchorage delivery, refrigerated transport for fresh provisions, and bonded warehouses stocked with certified deck, engine, and cabin stores.</p>
</div>
</div>
</section>
...
<h2 class="font-headline-lg text-headline-lg-mobile md:text-headline-lg text-primary">Operational Capabilities</h2>
...
<h3 class="font-headline-md text-headline-md text-primary mb-3">24/7 Berth & Anchorage Delivery</h3>
<p class="font-body-md text-body-md text-on-surface-variant">Direct supply launch service for ships waiting at Port Said and Suez anchorages, plus direct truck delivery alongside all Egyptian berths.</p>
</div>
<!-- Capability 2 -->
<div class="bg-surface p-8 border border-outline-variant rounded-lg hover:border-primary transition-all shadow-sm flex flex-col items-start">
<div class="w-12 h-12 rounded bg-surface-container flex items-center justify-center text-primary mb-6">
...
<h3 class="font-headline-md text-headline-md text-primary mb-3">HACCP & IMPA/ISSA Compliance</h3>
<p class="font-body-md text-body-md text-on-surface-variant">Refrigerated food storage conforming to ISO 22000 & HACCP, plus IMPA & ISSA coded technical spares sourcing.</p>
</div>
<!-- Capability 3 -->
<div class="bg-surface p-8 border border-outline-variant rounded-lg hover:border-primary transition-all shadow-sm flex flex-col items-start">
<div class="w-12 h-12 rounded bg-surface-container flex items-center justify-center text-primary mb-6">
...
<h3 class="font-headline-md text-headline-md text-primary mb-3">Rapid Quotation & Clear Invoicing</h3>
<p class="font-body-md text-body-md text-on-surface-variant">Itemized quotations delivered within 2 hours of requisition receipt with clear pricing and zero hidden port fees.</p>
</div>
</div>
</section>
