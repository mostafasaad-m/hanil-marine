...
<main class="flex-grow">
	...
	<section class="relative w-full h-[60vh] min-h-[400px] flex items-center justify-center">
		...
		<div class="relative z-10 text-center px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto text-on-primary">
			...
			<a class="inline-flex items-center gap-2 bg-safety-orange text-on-primary font-button-text text-button-text px-6 py-3 rounded hover:bg-secondary-container transition-colors shadow-sm" href="<?php echo esc_url( home_url( '/step-1?service=' . urlencode( 'Crew Change Logistics' ) ) ); ?>">
	...
	<section class="bg-tertiary text-on-tertiary py-section-gap px-margin-mobile md:px-margin-desktop text-center" id="quote">
		<div class="max-w-3xl mx-auto">
			...
			<div class="flex flex-col sm:flex-row justify-center gap-4">
				<a class="bg-safety-orange text-on-primary font-button-text text-button-text px-8 py-3 rounded shadow-[0_4px_12px_rgba(0,0,0,0.1)] hover:opacity-90 transition-opacity" href="<?php echo esc_url( home_url( '/step-1?service=' . urlencode( 'Crew Change Logistics' ) ) ); ?>">
